...
class _CreateGraphScreenState extends State<CreateGraphScreen> {
  ...
  Future<void> _saveToKnowledgeGraph() async {
    ...
    final result = await _knowledgeGraphService.saveToKnowledgeGraph(
      title: _titleController.text.trim(),
      content: _contentController.text.trim(),
      phone: phone,
      userId: userId,
      youtubeUrl: _youtubeUrl,
      aiChatEnabled: _enableAiChat,
      aiProvider: _enableAiChat ? _aiProvider : null,
    ...
    if (result['success'] == true) {
      ...
      setState(() {
        _error = result['error'] ?? 'Failed to save';
        _saving = false;
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Create Knowledge Graph'),
          ...
          children: [
            ...
            if (_enableAiChat)
              ...
              Container(
                ...
                child: Text(
                  'Enable AI Assistant in Settings to chat while drafting.',
            ...
            // Save button
            ElevatedButton(
              onPressed: _saving ? null : _saveToKnowledgeGraph,
              style: ElevatedButton.styleFrom(
              ...
              child: _saving
                  ...
                  : const Text('Save to Knowledge Graph'),
            ),
